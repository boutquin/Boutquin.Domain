...
public sealed class DecimalArrayExtensionsTestData
{
    ...
    public static IEnumerable<object[]> VarianceData =>
        ...
        new object[] { new[] { -5m, 0m, 5m, 10m, 15m }, CalculationType.Population, 50m },
        new object[] { new[] { 0.01m, 0.02m, 0.03m, 0.04m, 0.05m }, CalculationType.Population, 0.0002m },
        new object[] { new[] { -1000m, 0m, 1000m }, CalculationType.Population, 666666.6666666666666666667m },
        new object[] { new[] { 100m, 200m, 300m, 400m, 500m, 600m, 700m }, CalculationType.Population, 40000m  },

        // CalculationType.Sample
        new object[] { new[] { 1m, 2m, 3m, 4m, 5m }, CalculationType.Sample, 2.5m },
        new object[] { new[] { 10m, 20m, 30m, 40m, 50m }, CalculationType.Sample, 250m },
        new object[] { new[] { -5m, 0m, 5m, 10m, 15m }, CalculationType.Sample, 62.5m },
    ...
    public static IEnumerable<object[]> StandardDeviationData =>
        ...
        new object[] { new[] { -5m, 0m, 5m, 10m, 15m }, CalculationType.Population, 7.0710678118654755m },
        new object[] { new[] { 0.01m, 0.02m, 0.03m, 0.04m, 0.05m }, CalculationType.Population, 0.0141421356237m },
        new object[] { new[] { -1000m, 0m, 1000m }, CalculationType.Population, 816.4965809277261m },
        new object[] { new[] { 100m, 200m, 300m, 400m, 500m, 600m, 700m }, CalculationType.Population, 200m },

        // CalculationType.Sample
        new object[] { new[] { 1m, 2m, 3m, 4m, 5m }, CalculationType.Sample, 1.5811388300841898m },
        new object[] { new[] { 10m, 20m, 30m, 40m, 50m }, CalculationType.Sample, 15.811388300841896m },
        new object[] { new[] { -5m, 0m, 5m, 10m, 15m }, CalculationType.Sample, 7.905694150420948m },
