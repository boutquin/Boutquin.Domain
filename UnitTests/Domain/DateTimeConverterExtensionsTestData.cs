...
public static class DateTimeConverterExtensionsTestData
{
    public static IEnumerable<object[]> ConvertTimeZoneCases =>
        [
            ...
            new object[] { new DateTime(2023, 3, 28, 12, 0, 0), "UTC", "Asia/Tokyo", new DateTime(2023, 3, 28, 21, 0, 0) },

            // Test case 3: Same source and target time zones
            new object[] { new DateTime(2023, 3, 28, 12, 0, 0), "UTC", "UTC", new DateTime(2023, 3, 28, 12, 0, 0) },
