...
public sealed class CustomExceptionHandlerMiddlewareExtensionsTests
{
    ...
    [Fact]
    public void UseCustomExceptionHandler_WithNullApp_ThrowsArgumentNullException()
    {
        // AC-4.1: the Guard.AgainstNull(() => app) call must surface a clear ArgumentNullException
        // rather than an opaque NullReferenceException from UseMiddleware on a null builder.
        IApplicationBuilder app = null!;

        Func<IApplicationBuilder> act = app.UseCustomExceptionHandler;
