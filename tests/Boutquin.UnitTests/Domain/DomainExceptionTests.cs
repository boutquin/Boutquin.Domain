...
public sealed class DomainExceptionTests
{
    ...
    public void BadRequestException_HasStatusCode400AndCorrectTitle()
    {
        ...
        // F-L5-01: the message-less constructor must carry a safe default, never the .NET framework
        // default that embeds the internal type name.
        exception.Message.Should().Be(ExceptionMessages.BadRequest);
    }
    ...
    public void UnauthorizedException_HasStatusCode401AndCorrectTitle()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.Unauthorized);
    }
    ...
    public void ForbiddenException_HasStatusCode403AndCorrectTitle()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.Forbidden);
    }
    ...
    public void NotFoundException_HasStatusCode404AndCorrectTitle()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.NotFound);
    }
    ...
    public void ConflictException_HasStatusCode409AndCorrectTitle()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.Conflict);
    }
    ...
    public void UnsupportedMediaTypeException_HasStatusCode415AndCorrectTitle()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.UnsupportedMediaType);
    }
    ...
    public void UnprocessableEntityException_HasStatusCode422AndCorrectTitle()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.UnprocessableEntity);
    }
    ...
    public void TooManyRequestsException_HasStatusCode429AndCorrectTitle()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.TooManyRequests);
    }
    ...
    public void EmptyOrNullCollectionException_DefaultConstructor_HasDefaultMessage()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.EmptyOrNullCollection);
    }
    ...
    public void EmptyOrNullDictionaryException_DefaultConstructor_HasDefaultMessage()
    {
        ...
        exception.Message.Should().Be(ExceptionMessages.EmptyOrNullDictionary);
    }
