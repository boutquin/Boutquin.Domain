...
public sealed class GuardCallerExpressionTests
{
    ...
    // ─── Captured parameter name (the point of CallerArgumentExpression) ─────────

    [Fact]
    public void AgainstNull_WhenNull_CapturesParameterName()
    {
        string? nullValue = null;
    ...
    [Fact]
    public void AgainstDefault_WhenDefault_CapturesParameterName()
    {
        var defaultValue = 0;

        var act = () => Guard.AgainstDefault(defaultValue);

        act.Should().Throw<ArgumentException>()
            .WithParameterName("defaultValue");
    }

    [Fact]
    public void AgainstNegative_WhenNegative_CapturesParameterName()
    {
        var amount = -1;

        var act = () => Guard.AgainstNegative(amount);
    ...
    [Fact]
    public void AgainstOutOfRange_AtInclusiveBoundaries_DoesNotThrow()
    {
        var atMin = () => Guard.AgainstOutOfRange(1, 1, 10);
        var atMax = () => Guard.AgainstOutOfRange(10, 1, 10);
    ...
    [Fact]
    public void AgainstNegative_AtZero_DoesNotThrow()
    {
        var act = () => Guard.AgainstNegative(0);
