...
#pragma warning restore CS8604
    ...
    [Fact]
    public void ConvertTimeZone_WhenSourceTimeZoneIdIsEmpty_ThrowsArgumentException()
    {
        // Arrange — a blank id must surface as a clear ArgumentException, not an opaque
        // TimeZoneNotFoundException about the empty string.
        var sourceDateTime = new DateTime(2024, 1, 1, 12, 0, 0, DateTimeKind.Unspecified);

        // Act
        var act = () => sourceDateTime.ConvertTimeZone(string.Empty, "UTC");
    ...
    [Fact]
    public void ConvertTimeZone_WhenSourceTimeZoneIdIsNull_ThrowsArgumentNullException()
    {
        // Arrange
        var sourceDateTime = new DateTime(2024, 1, 1, 12, 0, 0, DateTimeKind.Unspecified);
...
#pragma warning disable CS8625
        var act = () => sourceDateTime.ConvertTimeZone(null, "UTC");
