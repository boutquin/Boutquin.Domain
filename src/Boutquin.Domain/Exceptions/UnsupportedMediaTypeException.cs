...
/// </summary>
public sealed class UnsupportedMediaTypeException : DomainException
{
    private const int DefaultStatusCode = 415;
    private const string DefaultTitle = "Unsupported Media Type";

    /// <summary>
    /// Initializes a new instance of the <see cref="UnsupportedMediaTypeException"/> class with a default error message.
    /// </summary>
    public UnsupportedMediaTypeException()
        : base(DefaultStatusCode, DefaultTitle, ExceptionMessages.UnsupportedMediaType)
    {
    }
