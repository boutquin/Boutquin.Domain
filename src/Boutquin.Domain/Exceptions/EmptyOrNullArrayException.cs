...
/// </summary>
/// <remarks>
/// Derives from <see cref="ArgumentException"/> so an empty/null array failure is caught by a single
...
/// </remarks>
public sealed class EmptyOrNullArrayException : ArgumentException
{
    /// <summary>
