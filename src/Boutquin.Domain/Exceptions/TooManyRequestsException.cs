...
{
    private const int DefaultStatusCode = 429;
    private const string DefaultTitle = "Too Many Requests";

    /// <summary>
    /// Initializes a new instance of the <see cref="TooManyRequestsException"/> class with a default error message.
    /// </summary>
    public TooManyRequestsException()
        : base(DefaultStatusCode, DefaultTitle, ExceptionMessages.TooManyRequests)
    {
    }
